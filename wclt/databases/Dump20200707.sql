...
--
-- Table structure for table `con_types`
--

DROP TABLE IF EXISTS `con_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `con_types` (
  `contract_id` int NOT NULL AUTO_INCREMENT,
  `contract_name` varchar(31) DEFAULT NULL,
  PRIMARY KEY (`contract_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `con_types`
--

LOCK TABLES `con_types` WRITE;
/*!40000 ALTER TABLE `con_types` DISABLE KEYS */;
INSERT INTO `con_types` VALUES (1,'Franchise'),(2,'2-Way'),(3,'Standard'),(4,'Prospect'),(5,'Medic'),(6,'Assistant'),(7,'Scout');
/*!40000 ALTER TABLE `con_types` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `enhancements` VALUES (1,'Cocaine'),(2,'Marijuana'),(3,'Adderall'),(4,'Alcohol'),(5,'Steroids');
...
INSERT INTO `genders` VALUES (1,'Male'),(2,'Female'),(3,'Neither'),(4,'Both');
...
CREATE TABLE `player` (
  ...
  `p_tac_1` varchar(31) DEFAULT NULL,
  `p_tac_2` varchar(31) DEFAULT NULL,
  `p_tac_3` varchar(31) DEFAULT NULL,
  `p_r_status` varchar(31) DEFAULT NULL,
  ...
  KEY `team_idx` (`team`),
  KEY `addiction_idx` (`addiction`),
  KEY `personality_idx` (`personality`),
  KEY `region_idx` (`home_region`),
  KEY `sub_tree_idx` (`p_subs_for`),
  KEY `fk_con_type_idx` (`con_type`),
  KEY `fk_inj_idx` (`inj_type`),
  CONSTRAINT `fk_addict` FOREIGN KEY (`addiction`) REFERENCES `addiction` (`addiction_id`),
  CONSTRAINT `fk_con_type` FOREIGN KEY (`con_type`) REFERENCES `con_types` (`contract_id`),
...
INSERT INTO `region` VALUES (1,'Japan'),(2,'Korea'),(3,'New England'),(4,'Canada'),(5,'Caribbean'),(6,'United Kingdom'),(7,'Midwest'),(8,'Dixie'),(9,'Texas'),(10,'California'),(11,'Rockies'),(12,'Mid-Atlantic'),(13,'Mediterranean'),(14,'China'),(15,'Other'),(16,'The Future'),(17,'The Moon'),(18,'Mars'),(19,'The Belt'),(20,'Beyond');
...
-- Dump completed on 2020-07-07 16:04:25
